...
export default function ShopPage() {
  ...
  }, [session, search, inStockOnly, categoryId, collection, page, sort, favIds]);
          ...
          `}>
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 space-y-5 sticky top-20">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => { setCategoryId(null); setInStockOnly(false); setSearch(''); }}
              ...
              <div>
                ...
                <div className="space-y-0.5 max-h-[50vh] overflow-y-auto -mx-1 px-1">
                  {/* All Categories */}
                  <button
                    onClick={() => { setCategoryId(null); setPage(0); setExpandedCat(null); setExpandedSubCat(null); setExpandedSubSubCat(null); if(window.innerWidth < 768) setSidebarOpen(false); }}
                    ...
                    return (
                      <div key={cat.id}>
                        ...
                        <div className={`flex items-center rounded-lg ${isActive ? 'bg-[#004475]' : 'hover:bg-gray-100'}`}>
                          <button
                            onClick={() => { setCategoryId(cat.id); setPage(0); if(window.innerWidth < 768) setSidebarOpen(false); }}
                              ...
                              return (
                                <div key={sub.id}>
                                  <div className={`flex items-center rounded-lg ${isSubActive ? 'bg-blue-50' : 'hover:bg-gray-50'}`}>
                                    <button
                                      onClick={() => { setCategoryId(sub.id); setPage(0); if(window.innerWidth < 768) setSidebarOpen(false); }}
